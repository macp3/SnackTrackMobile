    ...
    Column(
        ...
        Box(
            ...
            if (!recipe.imageUrl.isNullOrBlank()) {
                Text("Image URL: ${recipe.imageUrl}", color = Color.DarkGray)
            } else {
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            // --- PRZYCISKI AKCJI (Używamy DisplayButton) ---
            Row(
                ...
                DisplayButton(
                    ...
                    fontSize = 12,
                    containerColor = if(isFavourite) Color(0xFFFF9999) else Color(0xFFB7F999) // Czerwony dla usuwania ulubionego
                )
                ...
                if (isAuthor) {
                    DisplayButton(
                        ...
                        modifier = Modifier.weight(1f).height(50.dp),
                        fontSize = 12,
                        containerColor = Color(0xFFB7F999) // Standardowy zielony
                    )
                    ...
                    DisplayButton(
                        ...
                        modifier = Modifier.weight(1f).height(50.dp),
                        fontSize = 12,
                        containerColor = Color(0xFFFF9999) // Czerwony/Różowy dla usuwania
                    )
                }
            }
